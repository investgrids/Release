  ...
  return (
    <div className="rounded-[20px] border border-surface-border/7 bg-text-primary/[0.025] p-5">
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        <span className="text-[10px] font-bold uppercase tracking-[0.12em] text-text-muted">Market Catalysts</span>
      </div>
            ...
            <div key={i} className="flex items-start gap-4">
              ...
              <div className="relative flex flex-col items-center">
                ...
                {i < catalysts.length - 1 && (
                  <span className="mt-1 w-px flex-1 bg-text-primary/[0.07]" style={{ minHeight: 32 }} />
                )}
              </div>

              {/* Content */}
              <div className="flex-1 pb-3">
                <p className="text-[13px] font-semibold text-text-primary leading-5 mb-2">{c.title}</p>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-bold text-text-secondary shrink-0 w-8 text-right">
                    {c.probability}%
                  </span>
                </div>
              </div>
