...
// IPOCharts.tsx's own header comment for why.
const GmpChart        = dynamic(() => import("./IPOCharts").then(m => m.GmpChart),        { ssr: false });
const SectorTrendsDonut = dynamic(() => import("./IPOCharts").then(m => m.SectorTrendsDonut), { ssr: false });
...
export function IPOHubContent({ headingLevel = "h1" }: { headingLevel?: "h1" | "h2" }) {
        ...
        <div className="rounded-[24px] border border-surface-border/10 bg-text-primary/[0.02] p-5">
          ...
          <div className="flex items-center gap-4">
            <div className="h-36 w-36 shrink-0">
              <SectorTrendsDonut sectorTrends={sectorTrends} />
            </div>
