        ...
        {NAV.map(item => {
          ...
          return (
            <Link
              ...
              className="flex min-w-[110px] flex-1 items-center justify-center gap-1.5 rounded-lg px-3 py-2 text-[12px] font-semibold text-text-secondary transition hover:bg-text-primary/[0.04] hover:text-text-primary"
            >
