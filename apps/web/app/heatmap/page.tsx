...
export default function HeatmapPage() {
  return (
    <div className="mx-auto max-w-[1200px] px-6 py-16 pb-24">
      {/* Coming Soon card */}
      <div className="relative overflow-hidden rounded-[28px] border border-surface-border/8 bg-gradient-to-br from-surface-card to-surface-bg p-10 text-center">
        {/* Decorative glow */}
        ...
        {/* Icon */}
        <div className="relative mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-[22px] border border-surface-border/10 bg-text-primary/[0.04]">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="h-9 w-9 text-text-secondary">
        ...
        <h1 className="relative mb-3 text-3xl font-black tracking-tight text-text-primary">
          Nifty 50 Heatmap
        </h1>
        <p className="relative mx-auto mb-8 max-w-md text-[14px] leading-7 text-text-secondary">
        ...
        <div className="relative mx-auto mb-8 grid max-w-xl grid-cols-2 gap-3 text-left sm:grid-cols-3">
          {[
            ...
            <div key={f.label} className="flex items-center gap-2.5 rounded-2xl border border-surface-border/6 bg-text-primary/[0.02] px-3 py-2.5">
              <span className="text-text-secondary flex items-center">{f.icon}</span>
        ...
        <div className="relative flex flex-wrap items-center justify-center gap-3">
          <Link href="/market-intelligence"
            className="flex items-center gap-2 rounded-2xl bg-gradient-to-r from-violet-600 to-sky-500 px-5 py-2.5 text-[13px] font-semibold text-text-primary shadow-lg shadow-violet-500/20 transition hover:opacity-90">
